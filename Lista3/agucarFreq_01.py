...
#===================================================
#------------Tratamento para Agucar 01--------------
#===================================================
imgPath = "images/agucar_01.png"
...
img_orig = np.array(pil.open('images/agucar_01.png'))
...
for c in (1, 5, 20, 30, 40, 50):
    ...
    g_lapla.save("agucar_01_agucamentoLaplace" + str(c) + ".png")

    filtrosFreq.aplica("agucar_01_agucamentoLaplace" + str(c) + ".png", 250, filtrosFreq.GLPF, "GLPF250")
...
img_glpf_50 = np.array(pil.open('agucar_01_GLPF_50.png'))
img_glpf_100 = np.array(pil.open('agucar_01_GLPF_100.png'))
...
for k in (1, 5, 10):
    ...
    filtrosFreq.saveImgFromArray(mask_50, "agucar_01_mask_GLPF_50_k" + str(k) + ".png")
    filtrosFreq.saveImgFromArray(mask_100, "agucar_01_mask_GLPF_100_k" + str(k) + ".png")
    filtrosFreq.saveImgFromArray(g_50, "agucar_01_Final_mask_GLPF_50_k" + str(k) + ".png")
    filtrosFreq.saveImgFromArray(g_100, "agucar_01_Final_mask_GLPF_100_k" + str(k) + ".png")

    filtrosFreq.realceHistEq("agucar_01_Final_mask_GLPF_50_k" + str(k) + ".png", 180, "agucar_01_Final_mask_GLPF_50_k" + str(k))
    filtrosFreq.realceHistEq("agucar_01_Final_mask_GLPF_100_k" + str(k) + ".png", 180, "agucar_01_Final_mask_GLPF_100_k" + str(k))
